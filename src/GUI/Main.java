...
public class Main extends JFrame {
    ...
    private final Color MainColor = new Color(250, 250, 250);
    ...
    private void initComponent() {
        ...
        if (epDTO != null) {
            menuTaskbar = new MenuTaskbar(this, epDTO);
        } else {
    ...
    public Main(EmployeeDTO epDTO) throws UnsupportedLookAndFeelException {
        this.epDTO = epDTO;
        initComponent();
        setUI();
    }
